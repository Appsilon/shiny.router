...
Both this project's documentation page and **README.md** are generated with Rmarkdown, so if there is need to update them, then please add changes to **README.Rmd** file and run **build_readme.R** script.
