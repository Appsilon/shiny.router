...
In theory that would be it, but now let's introduce the mechanism of catching the
parameters from the URL. We will use `get_query_param` function. Our modified
Server code may look like this:
